#ifndef q3_mesh_array_2threads_
#define q3_mesh_array_2threads_
...
static uint64_t* q3_mesh_array_2threads_intersection_buffer;

extern inline void q3_mesh_array_2threads_doc1_0_col0_intersection0_decode_UA(uint32_t* doc1_0_col0_intersection_ptr_0, uint32_t & doc1_0_intersection0_fragment_size) __attribute__((always_inline));

extern inline void q3_mesh_array_2threads_doc1_1_col0_intersection1_decode_UA(uint32_t* doc1_1_col0_intersection_ptr_1, uint32_t & doc1_1_intersection1_fragment_size) __attribute__((always_inline));

extern inline void q3_mesh_array_2threads_intersection(uint32_t doc1_0_intersection0_fragment_size, uint32_t doc1_1_intersection1_fragment_size, uint32_t & q3_mesh_array_2threads_intersection_size) __attribute__((always_inline));

void* pthread_q3_mesh_array_2threads_worker(void* arguments);

extern inline void q3_mesh_array_2threads_author1_col0_decode_UA_threaded(int thread_id, uint32_t* author1_col0_ptr, uint32_t & author1_fragment_size) __attribute__((always_inline));

void q3_mesh_array_2threads_doc1_0_col0_intersection0_decode_UA(uint32_t* doc1_0_col0_intersection_ptr_0, uint32_t & doc1_0_intersection0_fragment_size) {
...
void q3_mesh_array_2threads_doc1_1_col0_intersection1_decode_UA(uint32_t* doc1_1_col0_intersection_ptr_1, uint32_t & doc1_1_intersection1_fragment_size) {
...
void q3_mesh_array_2threads_intersection(uint32_t doc1_0_intersection0_fragment_size, uint32_t doc1_1_intersection1_fragment_size, uint32_t & q3_mesh_array_2threads_intersection_size) {
	...
	while(!end) {
		...
		if (match) {
			q3_mesh_array_2threads_intersection_buffer[intersection_index++] = doc1_0_col0_intersection_buffer[its[0]];
			while(1) {
	...
	delete[] its;
	q3_mesh_array_2threads_intersection_size = intersection_index;
}
...
void* pthread_q3_mesh_array_2threads_worker(void* arguments) {
	...
	uint32_t q3_mesh_array_2threads_intersection_it = args->start;
	uint32_t q3_mesh_array_2threads_intersection_size = args->end;
	int thread_id = args->thread_id;

	for (; q3_mesh_array_2threads_intersection_it<q3_mesh_array_2threads_intersection_size; q3_mesh_array_2threads_intersection_it++) {

		unsigned char* frag_author1 = idx[1]->index_map[q3_mesh_array_2threads_intersection_buffer[q3_mesh_array_2threads_intersection_it]];
		if(frag_author1) {
			uint32_t* author1_col0_ptr = reinterpret_cast<uint32_t *>(&(frag_author1[0]));
			uint32_t author1_fragment_size = *author1_col0_ptr++;
			q3_mesh_array_2threads_author1_col0_decode_UA_threaded(thread_id, author1_col0_ptr, author1_fragment_size);
...
void q3_mesh_array_2threads_author1_col0_decode_UA_threaded(int thread_id, uint32_t* author1_col0_ptr, uint32_t & author1_fragment_size) {
...
extern "C" int* q3_mesh_array_2threads(int** null_checks, int term1, int term2) {
	...
	q3_mesh_array_2threads_intersection_buffer = new uint64_t[metadata.idx_max_fragment_sizes[1]];
	...
	q3_mesh_array_2threads_doc1_0_col0_intersection0_decode_UA(doc1_0_col0_intersection_ptr_0, doc1_0_intersection0_fragment_size);
	...
	q3_mesh_array_2threads_doc1_1_col0_intersection1_decode_UA(doc1_1_col0_intersection_ptr_1, doc1_1_intersection1_fragment_size);

	uint32_t q3_mesh_array_2threads_intersection_size = 0;
	q3_mesh_array_2threads_intersection(doc1_0_intersection0_fragment_size, doc1_1_intersection1_fragment_size, q3_mesh_array_2threads_intersection_size);

	uint32_t thread_size = q3_mesh_array_2threads_intersection_size/NUM_THREADS;
	uint32_t position = 0;
	...
	arguments[NUM_THREADS-1].end = q3_mesh_array_2threads_intersection_size;

	for (int i=0; i<NUM_THREADS; i++) {
		pthread_create(&threads[i], NULL, &pthread_q3_mesh_array_2threads_worker, (void *) &arguments[i]);
	}
	...
	delete[] q3_mesh_array_2threads_intersection_buffer;
