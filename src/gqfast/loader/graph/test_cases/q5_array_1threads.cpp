#ifndef q5_array_1threads_
#define q5_array_1threads_
...
extern inline void q5_array_1threads_doc1_col0_decode_UA(uint32_t* doc1_col0_ptr, uint32_t & doc1_fragment_size) __attribute__((always_inline));

extern inline void q5_array_1threads_term_col0_decode_UA(uint32_t* term_col0_ptr, uint32_t & term_fragment_size) __attribute__((always_inline));

void* pthread_q5_array_1threads_worker(void* arguments);

extern inline void q5_array_1threads_doc2_col0_decode_UA_threaded(int thread_id, uint32_t* doc2_col0_ptr, uint32_t & doc2_fragment_size) __attribute__((always_inline));

extern inline void q5_array_1threads_author2_col0_decode_UA_threaded(int thread_id, uint32_t* author2_col0_ptr, uint32_t & author2_fragment_size) __attribute__((always_inline));

void q5_array_1threads_doc1_col0_decode_UA(uint32_t* doc1_col0_ptr, uint32_t & doc1_fragment_size) {
...
void q5_array_1threads_term_col0_decode_UA(uint32_t* term_col0_ptr, uint32_t & term_fragment_size) {
...
void* pthread_q5_array_1threads_worker(void* arguments) {
	...
	for (; term_it < term_fragment_size; term_it++) {
		...
		if(frag_doc2) {
			...
			q5_array_1threads_doc2_col0_decode_UA_threaded(thread_id, doc2_col0_ptr, doc2_fragment_size);
			...
			for (uint32_t doc2_it = 0; doc2_it < doc2_fragment_size; doc2_it++) {
				...
				if (frag_author2) {
					...
					q5_array_1threads_author2_col0_decode_UA_threaded(thread_id, author2_col0_ptr, author2_fragment_size);
...
void q5_array_1threads_doc2_col0_decode_UA_threaded(int thread_id, uint32_t* doc2_col0_ptr, uint32_t & doc2_fragment_size) {
...
void q5_array_1threads_author2_col0_decode_UA_threaded(int thread_id, uint32_t* author2_col0_ptr, uint32_t & author2_fragment_size) {
...
extern "C" int* q5_array_1threads(int** null_checks, int author1) {
	...
	for (int author1_it = 0; author1_it<1; author1_it++) {
		...
		if(frag_doc1) {
			...
			q5_array_1threads_doc1_col0_decode_UA(doc1_col0_ptr, doc1_fragment_size);
			...
			for (uint32_t doc1_it = 0; doc1_it < doc1_fragment_size; doc1_it++) {
				...
				if(frag_term) {
					...
					q5_array_1threads_term_col0_decode_UA(term_col0_ptr, term_fragment_size);
					...
					for (int i=0; i<NUM_THREADS; i++) {
						pthread_create(&threads[i], NULL, &pthread_q5_array_1threads_worker, (void *) &arguments[i]);
					}
