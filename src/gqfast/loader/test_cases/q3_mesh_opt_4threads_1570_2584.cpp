...
extern inline void q3_mesh_opt_4threads_1570_2584_doc1_col0_intersection0_decode_BB(unsigned char* doc1_col0_intersection_ptr_0, uint32_t doc1_col0_bytes_intersection0, uint32_t & doc1_intersection0_fragment_size) __attribute__((always_inline));

extern inline void q3_mesh_opt_4threads_1570_2584_doc1_col0_intersection1_decode_BB(unsigned char* doc1_col0_intersection_ptr_1, uint32_t doc1_col0_bytes_intersection1, uint32_t & doc1_intersection1_fragment_size) __attribute__((always_inline));

extern inline void q3_mesh_opt_4threads_1570_2584_intersection(uint32_t doc1_intersection0_fragment_size, uint32_t doc1_intersection1_fragment_size, uint32_t & q3_mesh_opt_4threads_1570_2584_intersection_size) __attribute__((always_inline));
...
void q3_mesh_opt_4threads_1570_2584_doc1_col0_intersection0_decode_BB(unsigned char* doc1_col0_intersection_ptr_0, uint32_t doc1_col0_bytes_intersection0, uint32_t & doc1_intersection0_fragment_size) {
...
void q3_mesh_opt_4threads_1570_2584_doc1_col0_intersection1_decode_BB(unsigned char* doc1_col0_intersection_ptr_1, uint32_t doc1_col0_bytes_intersection1, uint32_t & doc1_intersection1_fragment_size) {
...
void q3_mesh_opt_4threads_1570_2584_intersection(uint32_t doc1_intersection0_fragment_size, uint32_t doc1_intersection1_fragment_size, uint32_t & q3_mesh_opt_4threads_1570_2584_intersection_size) { 
	...
	while(!end) {
		...
		if (match) {
			q3_mesh_opt_4threads_1570_2584_intersection_buffer[intersection_index++] = index3_col0_buffer[0][0][its[0]];
			while(1) {
...
extern "C" int* q3_mesh_opt_4threads_1570_2584(int** null_checks) {
	...
	q3_mesh_opt_4threads_1570_2584_doc1_col0_intersection0_decode_BB(doc1_col0_intersection_ptr_0, doc1_col0_bytes_intersection0, doc1_intersection0_fragment_size);
	...
	q3_mesh_opt_4threads_1570_2584_doc1_col0_intersection1_decode_BB(doc1_col0_intersection_ptr_1, doc1_col0_bytes_intersection1, doc1_intersection1_fragment_size);

	uint32_t q3_mesh_opt_4threads_1570_2584_intersection_size = 0;
	q3_mesh_opt_4threads_1570_2584_intersection(doc1_intersection0_fragment_size, doc1_intersection1_fragment_size, q3_mesh_opt_4threads_1570_2584_intersection_size);
