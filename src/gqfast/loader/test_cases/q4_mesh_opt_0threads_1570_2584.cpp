#ifndef q4_mesh_opt_0threads_1570_2584_
#define q4_mesh_opt_0threads_1570_2584_
...
static uint64_t* q4_mesh_opt_0threads_1570_2584_intersection_buffer;

static int* term1_col1_huffman_tree_array;
static bool* term1_col1_huffman_terminator_array;

extern inline void q4_mesh_opt_0threads_1570_2584_doc1_col0_intersection0_decode_BB(unsigned char* doc1_col0_intersection_ptr_0, uint32_t doc1_col0_bytes_intersection0, uint32_t & doc1_intersection0_fragment_size) __attribute__((always_inline));

extern inline void q4_mesh_opt_0threads_1570_2584_doc1_col0_intersection1_decode_BB(unsigned char* doc1_col0_intersection_ptr_1, uint32_t doc1_col0_bytes_intersection1, uint32_t & doc1_intersection1_fragment_size) __attribute__((always_inline));

extern inline void q4_mesh_opt_0threads_1570_2584_intersection(uint32_t doc1_intersection0_fragment_size, uint32_t doc1_intersection1_fragment_size, uint32_t & q4_mesh_opt_0threads_1570_2584_intersection_size) __attribute__((always_inline));

extern inline void q4_mesh_opt_0threads_1570_2584_term1_col0_decode_BB(unsigned char* term1_col0_ptr, uint32_t term1_col0_bytes, uint32_t & term1_fragment_size) __attribute__((always_inline));

extern inline void q4_mesh_opt_0threads_1570_2584_term1_col1_decode_Huffman(unsigned char* term1_col1_ptr, uint32_t term1_fragment_size) __attribute__((always_inline));

void q4_mesh_opt_0threads_1570_2584_doc1_col0_intersection0_decode_BB(unsigned char* doc1_col0_intersection_ptr_0, uint32_t doc1_col0_bytes_intersection0, uint32_t & doc1_intersection0_fragment_size) {
...
void q4_mesh_opt_0threads_1570_2584_doc1_col0_intersection1_decode_BB(unsigned char* doc1_col0_intersection_ptr_1, uint32_t doc1_col0_bytes_intersection1, uint32_t & doc1_intersection1_fragment_size) {
...
void q4_mesh_opt_0threads_1570_2584_intersection(uint32_t doc1_intersection0_fragment_size, uint32_t doc1_intersection1_fragment_size, uint32_t & q4_mesh_opt_0threads_1570_2584_intersection_size) { 
	...
	while(!end) {
		...
		if (match) {
			q4_mesh_opt_0threads_1570_2584_intersection_buffer[intersection_index++] = index3_col0_buffer[0][0][its[0]];
			while(1) {
	...
	delete[] its;
	q4_mesh_opt_0threads_1570_2584_intersection_size = intersection_index;
}

void q4_mesh_opt_0threads_1570_2584_term1_col0_decode_BB(unsigned char* term1_col0_ptr, uint32_t term1_col0_bytes, uint32_t & term1_fragment_size) {
...
void q4_mesh_opt_0threads_1570_2584_term1_col1_decode_Huffman(unsigned char* term1_col1_ptr, uint32_t term1_fragment_size) {
...
extern "C" int* q4_mesh_opt_0threads_1570_2584(int** null_checks) {
	...
	q4_mesh_opt_0threads_1570_2584_intersection_buffer = new uint64_t[metadata.idx_max_fragment_sizes[3]];
	...
	q4_mesh_opt_0threads_1570_2584_doc1_col0_intersection0_decode_BB(doc1_col0_intersection_ptr_0, doc1_col0_bytes_intersection0, doc1_intersection0_fragment_size);
	...
	q4_mesh_opt_0threads_1570_2584_doc1_col0_intersection1_decode_BB(doc1_col0_intersection_ptr_1, doc1_col0_bytes_intersection1, doc1_intersection1_fragment_size);

	uint32_t q4_mesh_opt_0threads_1570_2584_intersection_size = 0;
	q4_mesh_opt_0threads_1570_2584_intersection(doc1_intersection0_fragment_size, doc1_intersection1_fragment_size, q4_mesh_opt_0threads_1570_2584_intersection_size);

	for (uint32_t q4_mesh_opt_0threads_1570_2584_intersection_it= 0; q4_mesh_opt_0threads_1570_2584_intersection_it<q4_mesh_opt_0threads_1570_2584_intersection_size; q4_mesh_opt_0threads_1570_2584_intersection_it++) {

		uint32_t* row_term1 = idx[2]->index_map[q4_mesh_opt_0threads_1570_2584_intersection_buffer[q4_mesh_opt_0threads_1570_2584_intersection_it]];
		uint32_t term1_col0_bytes = idx[2]->index_map[q4_mesh_opt_0threads_1570_2584_intersection_buffer[q4_mesh_opt_0threads_1570_2584_intersection_it]+1][0] - row_term1[0];
		if(term1_col0_bytes) {

			unsigned char* term1_col0_ptr = &(idx[2]->fragment_data[0][row_term1[0]]);
			uint32_t term1_fragment_size = 0;
			q4_mesh_opt_0threads_1570_2584_term1_col0_decode_BB(term1_col0_ptr, term1_col0_bytes, term1_fragment_size);

			unsigned char* term1_col1_ptr = &(idx[2]->fragment_data[1][row_term1[1]]);
			q4_mesh_opt_0threads_1570_2584_term1_col1_decode_Huffman(term1_col1_ptr, term1_fragment_size);
	...
	delete[] q4_mesh_opt_0threads_1570_2584_intersection_buffer;
