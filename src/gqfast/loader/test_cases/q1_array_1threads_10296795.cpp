#ifndef q1_array_1threads_10296795_
#define q1_array_1threads_10296795_
...
extern inline void q1_array_1threads_10296795_term1_col0_decode_UA(uint32_t* term1_col0_ptr, uint32_t term1_col0_bytes, uint32_t & term1_fragment_size) __attribute__((always_inline));

void* pthread_q1_array_1threads_10296795_worker(void* arguments);

extern inline void q1_array_1threads_10296795_doc2_col0_decode_UA_threaded(int thread_id, uint32_t* doc2_col0_ptr, uint32_t doc2_col0_bytes, uint32_t & doc2_fragment_size) __attribute__((always_inline));

void q1_array_1threads_10296795_term1_col0_decode_UA(uint32_t* term1_col0_ptr, uint32_t term1_col0_bytes, uint32_t & term1_fragment_size) {
...
void* pthread_q1_array_1threads_10296795_worker(void* arguments) {
	...
	for (; term1_it < term1_fragment_size; term1_it++) {
		...
		if(doc2_col0_bytes) {
			...
			q1_array_1threads_10296795_doc2_col0_decode_UA_threaded(thread_id, doc2_col0_ptr, doc2_col0_bytes, doc2_fragment_size);
...
void q1_array_1threads_10296795_doc2_col0_decode_UA_threaded(int thread_id, uint32_t* doc2_col0_ptr, uint32_t doc2_col0_bytes, uint32_t & doc2_fragment_size) {
...
extern "C" int* q1_array_1threads_10296795(int** null_checks) {
	...
	for (int doc1_it = 0; doc1_it<1; doc1_it++) {
		...
		if(term1_col0_bytes) {
			...
			q1_array_1threads_10296795_term1_col0_decode_UA(term1_col0_ptr, term1_col0_bytes, term1_fragment_size);
			...
			for (int i=0; i<NUM_THREADS; i++) {
				pthread_create(&threads[i], NULL, &pthread_q1_array_1threads_10296795_worker, (void *) &arguments[i]);
			}
