...
extern inline void test_pubmed_q5_opt_doc1_col0_decode_BB(unsigned char* doc1_col0_ptr, int32_t doc1_col0_bytes, int32_t & doc1_fragment_size) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_term_col0_decode_BB(unsigned char* term_col0_ptr, int32_t term_col0_bytes, int32_t & term_fragment_size) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_term_col1_decode_Huffman(unsigned char* term_col1_ptr, int32_t term_fragment_size) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_doc2_col0_decode_BB(unsigned char* doc2_col0_ptr, int32_t doc2_col0_bytes, int32_t & doc2_fragment_size) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_doc2_col1_decode_Huffman(unsigned char* doc2_col1_ptr, int32_t doc2_fragment_size) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_year_col0_decode_BCA(int64_t* year_col0_ptr, uint32_t & year_col0_element) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_author2_col0_decode_BCA(unsigned char* author2_col0_ptr, int32_t author2_col0_bytes, int32_t & author2_fragment_size) __attribute__((always_inline));

void test_pubmed_q5_opt_doc1_col0_decode_BB(unsigned char* doc1_col0_ptr, int32_t doc1_col0_bytes, int32_t & doc1_fragment_size) {
...
void test_pubmed_q5_opt_term_col0_decode_BB(unsigned char* term_col0_ptr, int32_t term_col0_bytes, int32_t & term_fragment_size) {
...
void test_pubmed_q5_opt_term_col1_decode_Huffman(unsigned char* term_col1_ptr, int32_t term_fragment_size) {
...
void test_pubmed_q5_opt_doc2_col0_decode_BB(unsigned char* doc2_col0_ptr, int32_t doc2_col0_bytes, int32_t & doc2_fragment_size) {
...
void test_pubmed_q5_opt_doc2_col1_decode_Huffman(unsigned char* doc2_col1_ptr, int32_t doc2_fragment_size) {
...
void test_pubmed_q5_opt_year_col0_decode_BCA(int64_t* year_col0_ptr, uint32_t & year_col0_element) {

	year_col0_element = year_col0_bits_info[1];
	year_col0_element &= *year_col0_ptr;
}

void test_pubmed_q5_opt_author2_col0_decode_BCA(unsigned char* author2_col0_ptr, int32_t author2_col0_bytes, int32_t & author2_fragment_size) {
