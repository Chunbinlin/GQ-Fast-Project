#ifndef test_pubmed_q5_opt_
#define test_pubmed_q5_opt_
...
extern inline void test_pubmed_q5_opt_doc1_col0_decode_BB(unsigned char* doc1_col0_ptr, uint32_t doc1_col0_bytes, uint32_t & doc1_fragment_size) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_term_col0_decode_BB(unsigned char* term_col0_ptr, uint32_t term_col0_bytes, uint32_t & term_fragment_size) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_term_col1_decode_Huffman(unsigned char* term_col1_ptr, uint32_t term_fragment_size) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_doc2_col0_decode_BB(unsigned char* doc2_col0_ptr, uint32_t doc2_col0_bytes, uint32_t & doc2_fragment_size) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_doc2_col1_decode_Huffman(unsigned char* doc2_col1_ptr, uint32_t doc2_fragment_size) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_year_col0_decode_BCA(uint64_t* year_col0_ptr, uint32_t & year_col0_element) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_author2_col0_decode_BCA(unsigned char* author2_col0_ptr, uint32_t author2_col0_bytes, uint32_t & author2_fragment_size) __attribute__((always_inline));

void test_pubmed_q5_opt_doc1_col0_decode_BB(unsigned char* doc1_col0_ptr, uint32_t doc1_col0_bytes, uint32_t & doc1_fragment_size) {
...
void test_pubmed_q5_opt_term_col0_decode_BB(unsigned char* term_col0_ptr, uint32_t term_col0_bytes, uint32_t & term_fragment_size) {
...
void test_pubmed_q5_opt_term_col1_decode_Huffman(unsigned char* term_col1_ptr, uint32_t term_fragment_size) {
...
void test_pubmed_q5_opt_doc2_col0_decode_BB(unsigned char* doc2_col0_ptr, uint32_t doc2_col0_bytes, uint32_t & doc2_fragment_size) {
...
void test_pubmed_q5_opt_doc2_col1_decode_Huffman(unsigned char* doc2_col1_ptr, uint32_t doc2_fragment_size) {
...
void test_pubmed_q5_opt_year_col0_decode_BCA(uint64_t* year_col0_ptr, uint32_t & year_col0_element) {

	year_col0_element = year_col0_bits_info[1];
	year_col0_element &= *year_col0_ptr;
}

void test_pubmed_q5_opt_author2_col0_decode_BCA(unsigned char* author2_col0_ptr, uint32_t author2_col0_bytes, uint32_t & author2_fragment_size) {
...
extern "C" double* test_pubmed_q5_opt(int** null_checks) {
	...
	for (int author1_it = 0; author1_it<1; author1_it++) {
		...
		if(doc1_col0_bytes) {
			...
			test_pubmed_q5_opt_doc1_col0_decode_BB(doc1_col0_ptr, doc1_col0_bytes, doc1_fragment_size);
			...
			for (uint32_t doc1_it = 0; doc1_it < doc1_fragment_size; doc1_it++) {
				...
				if(term_col0_bytes) {
					...
					test_pubmed_q5_opt_term_col0_decode_BB(term_col0_ptr, term_col0_bytes, term_fragment_size);

					unsigned char* term_col1_ptr = &(idx[2]->fragment_data[1][row_op2[1]]);
					test_pubmed_q5_opt_term_col1_decode_Huffman(term_col1_ptr, term_fragment_size);
					...
					for (uint32_t term_it = 0; term_it < term_fragment_size; term_it++) {
						...
						if(doc2_col0_bytes) {
							...
							test_pubmed_q5_opt_doc2_col0_decode_BB(doc2_col0_ptr, doc2_col0_bytes, doc2_fragment_size);

							unsigned char* doc2_col1_ptr = &(idx[3]->fragment_data[1][row_op3[1]]);
							test_pubmed_q5_opt_doc2_col1_decode_Huffman(doc2_col1_ptr, doc2_fragment_size);
							...
							for (uint32_t doc2_it = 0; doc2_it < doc2_fragment_size; doc2_it++) {
								...
								uint64_t* year_col0_ptr = reinterpret_cast<uint64_t *>(&(idx[1]->fragment_data[0][row_op4[0]]));
								uint32_t year_col0_element;
								test_pubmed_q5_opt_year_col0_decode_BCA(year_col0_ptr, year_col0_element);
								...
								if(author2_col0_bytes) {
									...
									unsigned char* author2_col0_ptr = &(idx[4]->fragment_data[0][row_op5[0]]);
									uint32_t author2_fragment_size = 0;
									test_pubmed_q5_opt_author2_col0_decode_BCA(author2_col0_ptr, author2_col0_bytes, author2_fragment_size);
