#ifndef q3_tag_array_1threads_231_4366_
...
extern inline void q3_tag_array_1threads_231_4366_doc1_0_col0_intersection0_decode_UA(uint32_t* doc1_0_col0_intersection_ptr_0, uint32_t doc1_0_col0_bytes_intersection0, uint32_t & doc1_0_intersection0_fragment_size) __attribute__((always_inline));

extern inline void q3_tag_array_1threads_231_4366_doc1_1_col0_intersection1_decode_UA(uint32_t* doc1_1_col0_intersection_ptr_1, uint32_t doc1_1_col0_bytes_intersection1, uint32_t & doc1_1_intersection1_fragment_size) __attribute__((always_inline));

extern inline void q3_tag_array_1threads_231_4366_intersection(uint32_t doc1_0_intersection0_fragment_size, uint32_t doc1_1_intersection1_fragment_size, uint32_t & q3_tag_array_1threads_231_4366_intersection_size) __attribute__((always_inline));
...
void q3_tag_array_1threads_231_4366_doc1_0_col0_intersection0_decode_UA(uint32_t* doc1_0_col0_intersection_ptr_0, uint32_t doc1_0_col0_bytes_intersection0, uint32_t & doc1_0_intersection0_fragment_size) {
...
void q3_tag_array_1threads_231_4366_doc1_1_col0_intersection1_decode_UA(uint32_t* doc1_1_col0_intersection_ptr_1, uint32_t doc1_1_col0_bytes_intersection1, uint32_t & doc1_1_intersection1_fragment_size) {
...
void q3_tag_array_1threads_231_4366_intersection(uint32_t doc1_0_intersection0_fragment_size, uint32_t doc1_1_intersection1_fragment_size, uint32_t & q3_tag_array_1threads_231_4366_intersection_size) { 
	...
	while(!end) {
		...
		if (match) {
			q3_tag_array_1threads_231_4366_intersection_buffer[intersection_index++] = doc1_0_col0_intersection_buffer[its[0]];
			while(1) {
...
extern "C" int* q3_tag_array_1threads_231_4366(int** null_checks) {
	...
	q3_tag_array_1threads_231_4366_doc1_0_col0_intersection0_decode_UA(doc1_0_col0_intersection_ptr_0, doc1_0_col0_bytes_intersection0, doc1_0_intersection0_fragment_size);
	...
	q3_tag_array_1threads_231_4366_doc1_1_col0_intersection1_decode_UA(doc1_1_col0_intersection_ptr_1, doc1_1_col0_bytes_intersection1, doc1_1_intersection1_fragment_size);

	uint32_t q3_tag_array_1threads_231_4366_intersection_size = 0;
	q3_tag_array_1threads_231_4366_intersection(doc1_0_intersection0_fragment_size, doc1_1_intersection1_fragment_size, q3_tag_array_1threads_231_4366_intersection_size);
