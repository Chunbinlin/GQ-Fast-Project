...
extern inline void test_smdb_array_4threads_concept_semtype1_col0_decode_UA(int32_t* concept_semtype1_col0_ptr, int32_t concept_semtype1_col0_bytes, int32_t & concept_semtype1_fragment_size) __attribute__((always_inline));

void* pthread_test_smdb_array_4threads_worker(void* arguments);

extern inline void test_smdb_array_4threads_predication1_col0_decode_UA_threaded(int thread_id, int32_t* predication1_col0_ptr, int32_t predication1_col0_bytes, int32_t & predication1_fragment_size) __attribute__((always_inline));

extern inline void test_smdb_array_4threads_sentence1_col0_decode_UA_threaded(int thread_id, int32_t* sentence1_col0_ptr, int32_t sentence1_col0_bytes, int32_t & sentence1_fragment_size) __attribute__((always_inline));

extern inline void test_smdb_array_4threads_predication2_col0_decode_UA_threaded(int thread_id, int32_t* predication2_col0_ptr, int32_t predication2_col0_bytes, int32_t & predication2_fragment_size) __attribute__((always_inline));

extern inline void test_smdb_array_4threads_concept_semtype2_col0_decode_UA_threaded(int thread_id, int32_t* concept_semtype2_col0_ptr, int32_t concept_semtype2_col0_bytes, int32_t & concept_semtype2_fragment_size) __attribute__((always_inline));

extern inline void test_smdb_array_4threads_concept2_col0_decode_UA_threaded(int thread_id, int32_t* concept2_col0_ptr, int32_t concept2_col0_bytes, int32_t & concept2_fragment_size) __attribute__((always_inline));

void test_smdb_array_4threads_concept_semtype1_col0_decode_UA(int32_t* concept_semtype1_col0_ptr, int32_t concept_semtype1_col0_bytes, int32_t & concept_semtype1_fragment_size) {
...
void test_smdb_array_4threads_predication1_col0_decode_UA_threaded(int thread_id, int32_t* predication1_col0_ptr, int32_t predication1_col0_bytes, int32_t & predication1_fragment_size) {
...
void test_smdb_array_4threads_sentence1_col0_decode_UA_threaded(int thread_id, int32_t* sentence1_col0_ptr, int32_t sentence1_col0_bytes, int32_t & sentence1_fragment_size) {
...
void test_smdb_array_4threads_predication2_col0_decode_UA_threaded(int thread_id, int32_t* predication2_col0_ptr, int32_t predication2_col0_bytes, int32_t & predication2_fragment_size) {
...
void test_smdb_array_4threads_concept_semtype2_col0_decode_UA_threaded(int thread_id, int32_t* concept_semtype2_col0_ptr, int32_t concept_semtype2_col0_bytes, int32_t & concept_semtype2_fragment_size) {
...
void test_smdb_array_4threads_concept2_col0_decode_UA_threaded(int thread_id, int32_t* concept2_col0_ptr, int32_t concept2_col0_bytes, int32_t & concept2_fragment_size) {
