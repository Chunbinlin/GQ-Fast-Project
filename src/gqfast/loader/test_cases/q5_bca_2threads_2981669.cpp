#ifndef q5_bca_2threads_2981669_
#define q5_bca_2threads_2981669_
...
extern inline void q5_bca_2threads_2981669_doc1_col0_decode_BCA(unsigned char* doc1_col0_ptr, uint32_t doc1_col0_bytes, uint32_t & doc1_fragment_size) __attribute__((always_inline));

extern inline void q5_bca_2threads_2981669_term_col0_decode_BCA(unsigned char* term_col0_ptr, uint32_t term_col0_bytes, uint32_t & term_fragment_size) __attribute__((always_inline));

extern inline void q5_bca_2threads_2981669_term_col1_decode_BCA(unsigned char* term_col1_ptr, uint32_t term_fragment_size) __attribute__((always_inline));

void* pthread_q5_bca_2threads_2981669_worker(void* arguments);

extern inline void q5_bca_2threads_2981669_doc2_col0_decode_BCA_threaded(int thread_id, unsigned char* doc2_col0_ptr, uint32_t doc2_col0_bytes, uint32_t & doc2_fragment_size) __attribute__((always_inline));

extern inline void q5_bca_2threads_2981669_doc2_col1_decode_BCA_threaded(int thread_id, unsigned char* doc2_col1_ptr, uint32_t doc2_fragment_size) __attribute__((always_inline));

extern inline void q5_bca_2threads_2981669_year_col0_decode_BCA(uint64_t* year_col0_ptr, uint32_t & year_col0_element) __attribute__((always_inline));

extern inline void q5_bca_2threads_2981669_author2_col0_decode_BCA_threaded(int thread_id, unsigned char* author2_col0_ptr, uint32_t author2_col0_bytes, uint32_t & author2_fragment_size) __attribute__((always_inline));

void q5_bca_2threads_2981669_doc1_col0_decode_BCA(unsigned char* doc1_col0_ptr, uint32_t doc1_col0_bytes, uint32_t & doc1_fragment_size) {
...
void q5_bca_2threads_2981669_term_col0_decode_BCA(unsigned char* term_col0_ptr, uint32_t term_col0_bytes, uint32_t & term_fragment_size) {
...
void q5_bca_2threads_2981669_term_col1_decode_BCA(unsigned char* term_col1_ptr, uint32_t term_fragment_size) {
...
void* pthread_q5_bca_2threads_2981669_worker(void* arguments) {
	...
	for (; term_it < term_fragment_size; term_it++) {
		...
		if(doc2_col0_bytes) {
			...
			q5_bca_2threads_2981669_doc2_col0_decode_BCA_threaded(thread_id, doc2_col0_ptr, doc2_col0_bytes, doc2_fragment_size);

			unsigned char* doc2_col1_ptr = &(idx[3]->fragment_data[1][row_doc2[1]]);
			q5_bca_2threads_2981669_doc2_col1_decode_BCA_threaded(thread_id, doc2_col1_ptr, doc2_fragment_size);
			...
			for (uint32_t doc2_it = 0; doc2_it < doc2_fragment_size; doc2_it++) {
				...
				q5_bca_2threads_2981669_year_col0_decode_BCA(year_col0_ptr, year_col0_element);
				...
				if(author2_col0_bytes) {
					...
					q5_bca_2threads_2981669_author2_col0_decode_BCA_threaded(thread_id, author2_col0_ptr, author2_col0_bytes, author2_fragment_size);
...
void q5_bca_2threads_2981669_doc2_col0_decode_BCA_threaded(int thread_id, unsigned char* doc2_col0_ptr, uint32_t doc2_col0_bytes, uint32_t & doc2_fragment_size) {
...
void q5_bca_2threads_2981669_doc2_col1_decode_BCA_threaded(int thread_id, unsigned char* doc2_col1_ptr, uint32_t doc2_fragment_size) {
...
void q5_bca_2threads_2981669_year_col0_decode_BCA(uint64_t* year_col0_ptr, uint32_t & year_col0_element) {
...
void q5_bca_2threads_2981669_author2_col0_decode_BCA_threaded(int thread_id, unsigned char* author2_col0_ptr, uint32_t author2_col0_bytes, uint32_t & author2_fragment_size) {
...
extern "C" double* q5_bca_2threads_2981669(int** null_checks) {
	...
	for (int author1_it = 0; author1_it<1; author1_it++) {
		...
		if(doc1_col0_bytes) {
			...
			q5_bca_2threads_2981669_doc1_col0_decode_BCA(doc1_col0_ptr, doc1_col0_bytes, doc1_fragment_size);
			...
			for (uint32_t doc1_it = 0; doc1_it < doc1_fragment_size; doc1_it++) {
				...
				if(term_col0_bytes) {
					...
					q5_bca_2threads_2981669_term_col0_decode_BCA(term_col0_ptr, term_col0_bytes, term_fragment_size);

					unsigned char* term_col1_ptr = &(idx[2]->fragment_data[1][row_term[1]]);
					q5_bca_2threads_2981669_term_col1_decode_BCA(term_col1_ptr, term_fragment_size);
					...
					for (int i=0; i<NUM_THREADS; i++) {
						pthread_create(&threads[i], NULL, &pthread_q5_bca_2threads_2981669_worker, (void *) &arguments[i]);
					}
