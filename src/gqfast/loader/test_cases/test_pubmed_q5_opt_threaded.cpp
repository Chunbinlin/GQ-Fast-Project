#ifndef test_pubmed_q5_opt_threaded_
#define test_pubmed_q5_opt_threaded_
...
extern inline void test_pubmed_q5_opt_threaded_doc1_col0_decode_BB(unsigned char* doc1_col0_ptr, int32_t doc1_col0_bytes, int32_t & doc1_fragment_size) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_threaded_term_col0_decode_BB(unsigned char* term_col0_ptr, int32_t term_col0_bytes, int32_t & term_fragment_size) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_threaded_term_col1_decode_Huffman(unsigned char* term_col1_ptr, int32_t term_fragment_size) __attribute__((always_inline));

void* pthread_test_pubmed_q5_opt_threaded_worker(void* arguments);

extern inline void test_pubmed_q5_opt_threaded_doc2_col0_decode_BB_threaded(int thread_id, unsigned char* doc2_col0_ptr, int32_t doc2_col0_bytes, int32_t & doc2_fragment_size) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_threaded_doc2_col1_decode_Huffman_threaded(int thread_id, unsigned char* doc2_col1_ptr, int32_t doc2_fragment_size) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_threaded_year_col0_decode_BCA(int64_t* year_col0_ptr, uint32_t & year_col0_element) __attribute__((always_inline));

extern inline void test_pubmed_q5_opt_threaded_author2_col0_decode_BCA_threaded(int thread_id, unsigned char* author2_col0_ptr, int32_t author2_col0_bytes, int32_t & author2_fragment_size) __attribute__((always_inline));

void test_pubmed_q5_opt_threaded_doc1_col0_decode_BB(unsigned char* doc1_col0_ptr, int32_t doc1_col0_bytes, int32_t & doc1_fragment_size) {
	...
	do { 
		doc1_col0_bytes--;
		int32_t next_seven_bits = *doc1_col0_ptr & 127;
...
void test_pubmed_q5_opt_threaded_term_col0_decode_BB(unsigned char* term_col0_ptr, int32_t term_col0_bytes, int32_t & term_fragment_size) {
	...
	do { 
		term_col0_bytes--;
		int32_t next_seven_bits = *term_col0_ptr & 127;
		next_seven_bits = next_seven_bits << shiftbits;
...
void test_pubmed_q5_opt_threaded_term_col1_decode_Huffman(unsigned char* term_col1_ptr, int32_t term_fragment_size) {
...
void* pthread_test_pubmed_q5_opt_threaded_worker(void* arguments) {
	...
	for (; term_it < term_fragment_size; term_it++) {
		...
		if(doc2_col0_bytes) {
			...
			test_pubmed_q5_opt_threaded_doc2_col0_decode_BB_threaded(thread_id, doc2_col0_ptr, doc2_col0_bytes, doc2_fragment_size);

			unsigned char* doc2_col1_ptr = &(idx[3]->fragment_data[1][row_doc2[1]]);
			test_pubmed_q5_opt_threaded_doc2_col1_decode_Huffman_threaded(thread_id, doc2_col1_ptr, doc2_fragment_size);
			...
			for (int32_t doc2_it = 0; doc2_it < doc2_fragment_size; doc2_it++) {
				...
				test_pubmed_q5_opt_threaded_year_col0_decode_BCA(year_col0_ptr, year_col0_element);
				...
				if(author2_col0_bytes) {
					...
					test_pubmed_q5_opt_threaded_author2_col0_decode_BCA_threaded(thread_id, author2_col0_ptr, author2_col0_bytes, author2_fragment_size);
...
void test_pubmed_q5_opt_threaded_doc2_col0_decode_BB_threaded(int thread_id, unsigned char* doc2_col0_ptr, int32_t doc2_col0_bytes, int32_t & doc2_fragment_size) {
...
void test_pubmed_q5_opt_threaded_doc2_col1_decode_Huffman_threaded(int thread_id, unsigned char* doc2_col1_ptr, int32_t doc2_fragment_size) {
...
void test_pubmed_q5_opt_threaded_year_col0_decode_BCA(int64_t* year_col0_ptr, uint32_t & year_col0_element) {

	year_col0_element = year_col0_bits_info[1];
	year_col0_element &= *year_col0_ptr;
}

void test_pubmed_q5_opt_threaded_author2_col0_decode_BCA_threaded(int thread_id, unsigned char* author2_col0_ptr, int32_t author2_col0_bytes, int32_t & author2_fragment_size) {
...
extern "C" double* test_pubmed_q5_opt_threaded(int** null_checks) {
	...
	for (int author1_it = 0; author1_it<1; author1_it++) {
		...
		if(doc1_col0_bytes) {
			...
			test_pubmed_q5_opt_threaded_doc1_col0_decode_BB(doc1_col0_ptr, doc1_col0_bytes, doc1_fragment_size);
			...
			for (int32_t doc1_it = 0; doc1_it < doc1_fragment_size; doc1_it++) {
				...
				if(term_col0_bytes) {
					...
					test_pubmed_q5_opt_threaded_term_col0_decode_BB(term_col0_ptr, term_col0_bytes, term_fragment_size);

					unsigned char* term_col1_ptr = &(idx[2]->fragment_data[1][row_term[1]]);
					test_pubmed_q5_opt_threaded_term_col1_decode_Huffman(term_col1_ptr, term_fragment_size);
					...
					for (int i=0; i<NUM_THREADS; i++) {
						pthread_create(&threads[i], NULL, &pthread_test_pubmed_q5_opt_threaded_worker, (void *) &arguments[i]);
					}
