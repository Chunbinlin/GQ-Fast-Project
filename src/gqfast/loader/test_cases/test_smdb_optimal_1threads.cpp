...
extern inline void test_smdb_optimal_1threads_concept_semtype1_col0_decode_BB(unsigned char* concept_semtype1_col0_ptr, int32_t concept_semtype1_col0_bytes, int32_t & concept_semtype1_fragment_size) __attribute__((always_inline));

extern inline void test_smdb_optimal_1threads_predication1_col0_decode_BB(unsigned char* predication1_col0_ptr, int32_t predication1_col0_bytes, int32_t & predication1_fragment_size) __attribute__((always_inline));

extern inline void test_smdb_optimal_1threads_sentence1_col0_decode_BB(unsigned char* sentence1_col0_ptr, int32_t sentence1_col0_bytes, int32_t & sentence1_fragment_size) __attribute__((always_inline));

extern inline void test_smdb_optimal_1threads_predication2_col0_decode_Huffman(unsigned char* predication2_col0_ptr, int32_t predication2_col0_bytes, int32_t & predication2_fragment_size) __attribute__((always_inline));

extern inline void test_smdb_optimal_1threads_concept_semtype2_col0_decode_Huffman(unsigned char* concept_semtype2_col0_ptr, int32_t concept_semtype2_col0_bytes, int32_t & concept_semtype2_fragment_size) __attribute__((always_inline));

extern inline void test_smdb_optimal_1threads_concept2_col0_decode_BB(unsigned char* concept2_col0_ptr, int32_t concept2_col0_bytes, int32_t & concept2_fragment_size) __attribute__((always_inline));

void test_smdb_optimal_1threads_concept_semtype1_col0_decode_BB(unsigned char* concept_semtype1_col0_ptr, int32_t concept_semtype1_col0_bytes, int32_t & concept_semtype1_fragment_size) {
...
void test_smdb_optimal_1threads_predication1_col0_decode_BB(unsigned char* predication1_col0_ptr, int32_t predication1_col0_bytes, int32_t & predication1_fragment_size) {
...
void test_smdb_optimal_1threads_sentence1_col0_decode_BB(unsigned char* sentence1_col0_ptr, int32_t sentence1_col0_bytes, int32_t & sentence1_fragment_size) {
...
void test_smdb_optimal_1threads_predication2_col0_decode_Huffman(unsigned char* predication2_col0_ptr, int32_t predication2_col0_bytes, int32_t & predication2_fragment_size) {
...
void test_smdb_optimal_1threads_concept_semtype2_col0_decode_Huffman(unsigned char* concept_semtype2_col0_ptr, int32_t concept_semtype2_col0_bytes, int32_t & concept_semtype2_fragment_size) {
...
void test_smdb_optimal_1threads_concept2_col0_decode_BB(unsigned char* concept2_col0_ptr, int32_t concept2_col0_bytes, int32_t & concept2_fragment_size) {
