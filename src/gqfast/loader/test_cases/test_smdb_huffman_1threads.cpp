#ifndef test_smdb_huffman_1threads_
#define test_smdb_huffman_1threads_
...
extern inline void test_smdb_huffman_1threads_concept_semtype1_col0_decode_Huffman(unsigned char* concept_semtype1_col0_ptr, uint32_t concept_semtype1_col0_bytes, uint32_t & concept_semtype1_fragment_size) __attribute__((always_inline));

extern inline void test_smdb_huffman_1threads_predication1_col0_decode_Huffman(unsigned char* predication1_col0_ptr, uint32_t predication1_col0_bytes, uint32_t & predication1_fragment_size) __attribute__((always_inline));

extern inline void test_smdb_huffman_1threads_sentence1_col0_decode_Huffman(unsigned char* sentence1_col0_ptr, uint32_t sentence1_col0_bytes, uint32_t & sentence1_fragment_size) __attribute__((always_inline));

extern inline void test_smdb_huffman_1threads_predication2_col0_decode_Huffman(unsigned char* predication2_col0_ptr, uint32_t predication2_col0_bytes, uint32_t & predication2_fragment_size) __attribute__((always_inline));

extern inline void test_smdb_huffman_1threads_concept_semtype2_col0_decode_Huffman(unsigned char* concept_semtype2_col0_ptr, uint32_t concept_semtype2_col0_bytes, uint32_t & concept_semtype2_fragment_size) __attribute__((always_inline));

extern inline void test_smdb_huffman_1threads_concept2_col0_decode_Huffman(unsigned char* concept2_col0_ptr, uint32_t concept2_col0_bytes, uint32_t & concept2_fragment_size) __attribute__((always_inline));

void test_smdb_huffman_1threads_concept_semtype1_col0_decode_Huffman(unsigned char* concept_semtype1_col0_ptr, uint32_t concept_semtype1_col0_bytes, uint32_t & concept_semtype1_fragment_size) {
...
void test_smdb_huffman_1threads_predication1_col0_decode_Huffman(unsigned char* predication1_col0_ptr, uint32_t predication1_col0_bytes, uint32_t & predication1_fragment_size) {
	...
	while (predication1_col0_bytes > 1) {
		...
		buffer_arrays[1][0][0][0][predication1_fragment_size++] = *tree_array;
	}
...
void test_smdb_huffman_1threads_sentence1_col0_decode_Huffman(unsigned char* sentence1_col0_ptr, uint32_t sentence1_col0_bytes, uint32_t & sentence1_fragment_size) {
	...
	while (sentence1_col0_bytes > 1) {
		...
		buffer_arrays[2][0][0][0][sentence1_fragment_size++] = *tree_array;
	}
...
void test_smdb_huffman_1threads_predication2_col0_decode_Huffman(unsigned char* predication2_col0_ptr, uint32_t predication2_col0_bytes, uint32_t & predication2_fragment_size) {
	...
	while (predication2_col0_bytes > 1) {
		...
		buffer_arrays[3][0][0][0][predication2_fragment_size++] = *tree_array;
	}
...
void test_smdb_huffman_1threads_concept_semtype2_col0_decode_Huffman(unsigned char* concept_semtype2_col0_ptr, uint32_t concept_semtype2_col0_bytes, uint32_t & concept_semtype2_fragment_size) {
	...
	while (concept_semtype2_col0_bytes > 1) {
		...
		buffer_arrays[4][0][0][0][concept_semtype2_fragment_size++] = *tree_array;
	}
...
void test_smdb_huffman_1threads_concept2_col0_decode_Huffman(unsigned char* concept2_col0_ptr, uint32_t concept2_col0_bytes, uint32_t & concept2_fragment_size) {
	...
	while (concept2_col0_bytes > 1) {
		...
		buffer_arrays[5][0][0][0][concept2_fragment_size++] = *tree_array;
	}
...
extern "C" int* test_smdb_huffman_1threads(int** null_checks) {
	...
	for (int concept1_it = 0; concept1_it<1; concept1_it++) {
		...
		if(concept_semtype1_col0_bytes) {
			...
			test_smdb_huffman_1threads_concept_semtype1_col0_decode_Huffman(concept_semtype1_col0_ptr, concept_semtype1_col0_bytes, concept_semtype1_fragment_size);
			...
			for (uint32_t concept_semtype1_it = 0; concept_semtype1_it < concept_semtype1_fragment_size; concept_semtype1_it++) {
				...
				if(predication1_col0_bytes) {
					...
					test_smdb_huffman_1threads_predication1_col0_decode_Huffman(predication1_col0_ptr, predication1_col0_bytes, predication1_fragment_size);
					...
					for (uint32_t predication1_it = 0; predication1_it < predication1_fragment_size; predication1_it++) {
						...
						if(sentence1_col0_bytes) {
							...
							test_smdb_huffman_1threads_sentence1_col0_decode_Huffman(sentence1_col0_ptr, sentence1_col0_bytes, sentence1_fragment_size);
							...
							for (uint32_t sentence1_it = 0; sentence1_it < sentence1_fragment_size; sentence1_it++) {
								...
								if (!(sentence1_bool_array[buffer_arrays[2][0][0][0][sentence1_it]])) {
									...
									if(predication2_col0_bytes) {
										...
										test_smdb_huffman_1threads_predication2_col0_decode_Huffman(predication2_col0_ptr, predication2_col0_bytes, predication2_fragment_size);
										...
										for (uint32_t predication2_it = 0; predication2_it < predication2_fragment_size; predication2_it++) {
											...
											if(concept_semtype2_col0_bytes) {
												...
												test_smdb_huffman_1threads_concept_semtype2_col0_decode_Huffman(concept_semtype2_col0_ptr, concept_semtype2_col0_bytes, concept_semtype2_fragment_size);
												...
												for (uint32_t concept_semtype2_it = 0; concept_semtype2_it < concept_semtype2_fragment_size; concept_semtype2_it++) {
													...
													if(concept2_col0_bytes) {
														...
														test_smdb_huffman_1threads_concept2_col0_decode_Huffman(concept2_col0_ptr, concept2_col0_bytes, concept2_fragment_size);
