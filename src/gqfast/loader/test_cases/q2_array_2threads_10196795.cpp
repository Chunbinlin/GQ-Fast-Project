#ifndef q2_array_2threads_10196795_
#define q2_array_2threads_10196795_
...
extern inline void q2_array_2threads_10196795_year1_col0_decode_UA(uint32_t* year1_col0_ptr) __attribute__((always_inline));

extern inline void q2_array_2threads_10196795_term1_col0_decode_UA(uint32_t* term1_col0_ptr, uint32_t term1_col0_bytes, uint32_t & term1_fragment_size) __attribute__((always_inline));

extern inline void q2_array_2threads_10196795_term1_col1_decode_UA(unsigned char* term1_col1_ptr, uint32_t term1_fragment_size) __attribute__((always_inline));

void* pthread_q2_array_2threads_10196795_worker(void* arguments);

extern inline void q2_array_2threads_10196795_doc2_col0_decode_UA_threaded(int thread_id, uint32_t* doc2_col0_ptr, uint32_t doc2_col0_bytes, uint32_t & doc2_fragment_size) __attribute__((always_inline));

extern inline void q2_array_2threads_10196795_doc2_col1_decode_UA_threaded(int thread_id, unsigned char* doc2_col1_ptr, uint32_t doc2_fragment_size) __attribute__((always_inline));

extern inline void q2_array_2threads_10196795_year2_col0_decode_UA(uint32_t* year2_col0_ptr, uint32_t & year2_col0_element) __attribute__((always_inline));

void q2_array_2threads_10196795_year1_col0_decode_UA(uint32_t* year1_col0_ptr) {

	year1_col0_element = *year1_col0_ptr;
}

void q2_array_2threads_10196795_term1_col0_decode_UA(uint32_t* term1_col0_ptr, uint32_t term1_col0_bytes, uint32_t & term1_fragment_size) {
...
void q2_array_2threads_10196795_term1_col1_decode_UA(unsigned char* term1_col1_ptr, uint32_t term1_fragment_size) {
...
void* pthread_q2_array_2threads_10196795_worker(void* arguments) {
	...
	for (; term1_it < term1_fragment_size; term1_it++) {
		...
		if(doc2_col0_bytes) {
			...
			q2_array_2threads_10196795_doc2_col0_decode_UA_threaded(thread_id, doc2_col0_ptr, doc2_col0_bytes, doc2_fragment_size);

			unsigned char* doc2_col1_ptr = &(idx[3]->fragment_data[1][row_doc2[1]]);
			q2_array_2threads_10196795_doc2_col1_decode_UA_threaded(thread_id, doc2_col1_ptr, doc2_fragment_size);
			...
			for (uint32_t doc2_it = 0; doc2_it < doc2_fragment_size; doc2_it++) {
				...
				q2_array_2threads_10196795_year2_col0_decode_UA(year2_col0_ptr, year2_col0_element);
...
void q2_array_2threads_10196795_doc2_col0_decode_UA_threaded(int thread_id, uint32_t* doc2_col0_ptr, uint32_t doc2_col0_bytes, uint32_t & doc2_fragment_size) {
...
void q2_array_2threads_10196795_doc2_col1_decode_UA_threaded(int thread_id, unsigned char* doc2_col1_ptr, uint32_t doc2_fragment_size) {
...
void q2_array_2threads_10196795_year2_col0_decode_UA(uint32_t* year2_col0_ptr, uint32_t & year2_col0_element) {

	year2_col0_element = *year2_col0_ptr;
}

extern "C" double* q2_array_2threads_10196795(int** null_checks) {
	...
	for (int doc1_it = 0; doc1_it<1; doc1_it++) {
		...
		q2_array_2threads_10196795_year1_col0_decode_UA(year1_col0_ptr);
		...
		if(term1_col0_bytes) {
			...
			q2_array_2threads_10196795_term1_col0_decode_UA(term1_col0_ptr, term1_col0_bytes, term1_fragment_size);

			unsigned char* term1_col1_ptr = &(idx[2]->fragment_data[1][row_term1[1]]);
			q2_array_2threads_10196795_term1_col1_decode_UA(term1_col1_ptr, term1_fragment_size);
			...
			for (int i=0; i<NUM_THREADS; i++) {
				pthread_create(&threads[i], NULL, &pthread_q2_array_2threads_10196795_worker, (void *) &arguments[i]);
			}
