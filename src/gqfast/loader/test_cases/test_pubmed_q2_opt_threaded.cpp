...
extern inline void test_pubmed_q2_opt_threaded_year2_col0_decode_BCA(int64_t* year2_col0_ptr, uint32_t & year2_col0_element) __attribute__((always_inline));
...
void test_pubmed_q2_opt_threaded_year2_col0_decode_BCA(int64_t* year2_col0_ptr, uint32_t & year2_col0_element) {
