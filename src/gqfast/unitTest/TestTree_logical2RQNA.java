...
public class TestTree_logical2RQNA {
	...
	public void Tree1() {//Nothing need to be changed
		...
		TreeNode root = new TreeNode(Optypes.Selection, l1);
		root.left = new TreeNode(Optypes.Rename, l2);
		this.node = root;
	}
	...
	public void Tree2() {//need to add one projection
		...
		root.left = new TreeNode(Optypes.Selection, l2);
		root.left.left = new TreeNode(Optypes.Rename, l3);
		this.node = root;
	}
	...
	public void Tree3() {//need to push one selection with one join
		...
		List<Property> l3 = new ArrayList<Property>();
		l3.add(p3);
		root.left.left = new TreeNode(Optypes.Join, l3);
		...
		l4.add(p4);
		root.left.left.left = new TreeNode(Optypes.Rename, l4);
		...
		l5.add(p5);
		root.left.left.right = new TreeNode(Optypes.Rename, l5);
	...
	public void Tree4() {//need to add one projection
		...
		List<Property> l2 = new ArrayList<Property>();
		l2.add(p2);
		root.left = new TreeNode(Optypes.Semi_Join, l2);
		...
		List<Property> l3 = new ArrayList<Property>();
		l3.add(p3);
		root.left.right = new TreeNode(Optypes.Rename, l3);
		...
		l32.add(p32);
		root.left.left = new TreeNode(Optypes.Intersect, l32);
		...
		l42.add(p42);
		root.left.left.right.left = new TreeNode(Optypes.Selection,l42);
		Term t9 = new Term("dt", "");
		Term t10 = new Term("DT", "");
		Property p5 = new Property(t9, Conditions.eq, t10);
		List<Property> l5 = new ArrayList<Property>();
		l5.add(p5);
		root.left.left.right.left.left = new TreeNode(Optypes.Rename, l5);
		...
		l422.add(p422);
		root.left.left.left.left = new TreeNode(Optypes.Selection,l422);
		...
		l52.add(p52);
		root.left.left.left.left.left = new TreeNode(Optypes.Rename, l52);
	...
	public void Tree5() {//need to push one selection with two joins
		...
		root.left = new TreeNode(Optypes.Selection, l2);
		root.left.left = new TreeNode(Optypes.Join, l3);
		root.left.left.left = new TreeNode(Optypes.Join, l4);
		root.left.left.left.left = new TreeNode(Optypes.Rename, l51);
		root.left.left.left.right = new TreeNode(Optypes.Rename, l52);
		root.left.left.right = new TreeNode(Optypes.Rename, l53);
		this.node = root;
	}
	...
	public void Tree6() {//need to push one semijoin
		...
		l35.add(p35);
		root.left.left.left = new TreeNode(Optypes.Rename, l35);
		...
		l36.add(p36);
		root.left.left.right = new TreeNode(Optypes.Rename, l36);
		...
		List<Property> l32 = new ArrayList<Property>();
		l32.add(p32);
		root.left.right = new TreeNode(Optypes.Intersect, l32);
		...
		List<Property> l42 = new ArrayList<Property>();
		l42.add(p42);
		root.left.right.right.left = new TreeNode(Optypes.Selection,l42);
		Term t9 = new Term("cs", "");
		Term t10 = new Term("CS", "");
		Property p5 = new Property(t9, Conditions.eq, t10);
		List<Property> l5 = new ArrayList<Property>();
		l5.add(p5);
		root.left.right.right.left.left = new TreeNode(Optypes.Rename, l5);
		...
		List<Property> l422 = new ArrayList<Property>();
		l422.add(p422);
		root.left.right.left.left = new TreeNode(Optypes.Selection,l422);
		Term t92 = new Term("cs", "");
		Term t102 = new Term("CS", "");
		Property p52 = new Property(t92, Conditions.eq, t102);
		List<Property> l52 = new ArrayList<Property>();
		l52.add(p52);
		root.left.right.left.left.left = new TreeNode(Optypes.Rename, l52);
	...
	public void TreeFSD() {
		...
		l6.add(p6);
		root.left.left.left.left = new TreeNode(Optypes.Join, l6);
		...
		l8.add(p8);
		root.left.left.left.right = new TreeNode(Optypes.Rename, l8);
		...
		l9.add(p9);
		root.left.left.left.left.right = new TreeNode(Optypes.Rename, l9);
		...
		l10.add(p10);
		root.left.left.left.left.left = new TreeNode(Optypes.Rename, l10);
	...
	public void TreeAS() {
		...
		l62.add(p62);
		root.left.left.left.left.left = new TreeNode(Optypes.Join, l62);
		...
		List<Property> l10 = new ArrayList<Property>();
		l10.add(p10);
		root.left.left.left.left.left.right = new TreeNode(Optypes.Rename, l10);
		...
		l102.add(p102);
		root.left.left.left.left.left.left = new TreeNode(Optypes.Rename, l102);
	...
	public void TreeCS() {
		...
		List<Property> l6 = new ArrayList<Property>();
		l6.add(p6);
		root.left.left.left.left = new TreeNode(Optypes.Semi_Join, l6);
		...
		l63.add(p63);
		root.left.left.left.left.left.left = new TreeNode(Optypes.Join, l63);
		...
		List<Property> l102 = new ArrayList<Property>();
		l102.add(p102);
		root.left.left.left.left.left.left.right = new TreeNode(Optypes.Rename, l102);
		...
		l103.add(p103);
		root.left.left.left.left.left.left.left = new TreeNode(Optypes.Rename, l103);
	...
	public void print(TreeNode t) {
		if (t != null) {
			if (t.get_Optype() == Optypes.Join || t.get_Optype() == Optypes.Semi_Join || t.get_Optype() == Optypes.Intersect){
			System.out.print("\n{(");
			print(t.left);
			System.out.print(")\n");
			t.print();
